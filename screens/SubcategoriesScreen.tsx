...
export const SubcategoriesScreen: React.FC<SubcategoriesScreenProps> = ({ 
  ...
  return (
    <div className="relative flex flex-col w-full min-h-screen pb-24 bg-background-light dark:bg-background-dark">
      {/* Header */}
      <header className="sticky top-0 z-20 flex items-center gap-4 bg-white/95 dark:bg-background-dark/95 backdrop-blur-sm p-4 border-b border-gray-200 dark:border-white/5">
        <button 
          onClick={onBack}
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Selecione para contar</p>
        </div>
      </header>
